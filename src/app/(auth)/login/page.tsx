      ...
      >
        ...
        <div className="space-y-4">
          <button 
            ...
            className="w-full h-12 bg-orange-500 text-white rounded-xl font-bold shadow-sm transition-all hover:bg-orange-600 active:scale-[0.98] disabled:opacity-50 flex items-center justify-center"
          >
          ...
          <button 
            ...
            disabled={isLoading}
            className="w-full h-12 border border-gray-200 bg-white text-gray-700 rounded-xl font-bold transition-all hover:bg-gray-50 disabled:opacity-50"
          >
            Back to login
          </button>
        </div>
...
export default function LoginPage() {
  return (
    <AuthLayout>
      <Suspense fallback={<div className="w-full h-64 flex items-center justify-center"><Loader2 className="w-8 h-8 animate-spin text-orange-500" /></div>}>
        <LoginContent />
      </Suspense>
    </AuthLayout>
  );
